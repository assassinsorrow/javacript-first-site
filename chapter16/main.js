...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = 'fight monster, run away'
            break;
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (answers[3] == 'run away') {
                story.innerHTML = document.getElementById('answer31')
                theEnd();
            } else if (answers[3] == 'fight') {
                story.innerHTML = document.getElementById('awnser32')
                theEnd();
            } else {
